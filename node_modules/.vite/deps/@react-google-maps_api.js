...
var GoogleMap = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "mapRef", null);
    __publicField(this, "getInstance", () => {
      if (this.mapRef === null) {
        return null;
      }
      return new google.maps.Map(this.mapRef, this.props.options);
    });
    __publicField(this, "panTo", (latLng) => {
      const map = this.getInstance();
      if (map) {
        map.panTo(latLng);
      }
    });
    __publicField(this, "setMapCallback", () => {
...
var LoadScript = class extends import_react.PureComponent {
  constructor() {
    super(...arguments);
    __publicField(this, "check", (0, import_react.createRef)());
    __publicField(this, "state", {
      loaded: false
    });
    __publicField(this, "cleanupCallback", () => {
      delete window.google.maps;
      this.injectScript();
    });
    __publicField(this, "isCleaningUp", async () => {
    ...
    __publicField(this, "injectScript", () => {
...
__publicField(LoadScript, "defaultProps", defaultLoadScriptProps);
...
var TrafficLayer = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setTrafficLayerCallback", () => {
...
__publicField(TrafficLayer, "contextType", MapContext);
...
var BicyclingLayer = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setBicyclingLayerCallback", () => {
...
__publicField(BicyclingLayer, "contextType", MapContext);
...
var TransitLayer = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setTransitLayerCallback", () => {
...
__publicField(TransitLayer, "contextType", MapContext);
var eventMap$g = {
...
var DrawingManager = class extends import_react.PureComponent {
  constructor(props) {
    ...
    __publicField(this, "setDrawingManagerCallback", () => {
...
__publicField(DrawingManager, "contextType", MapContext);
var eventMap$f = {
...
function MarkerFunctional({ position, options, clusterer, noClustererRedraw, children, draggable, visible, animation, clickable, cursor, icon, label, opacity, shape, title, zIndex, onClick, onDblClick, onDrag, onDragEnd, onDragStart, onMouseOut, onMouseOver, onMouseUp, onMouseDown, onRightClick, onClickableChanged, onCursorChanged, onAnimationChanged, onDraggableChanged, onFlatChanged, onIconChanged, onPositionChanged, onShapeChanged, onTitleChanged, onVisibleChanged, onZindexChanged, onLoad, onUnmount }) {
  ...
  (0, import_react.useEffect)(() => {
    instance == null ? void 0 : instance.setAnimation(animation);
  }, [instance, animation]);
  (0, import_react.useEffect)(() => {
...
var Marker = class extends import_react.PureComponent {
  ...
  render() {
    const children = this.props.children ? import_react.Children.map(this.props.children, (child) => {
      if (!(0, import_react.isValidElement)(child)) {
        return child;
      }
      const elementChild = child;
...
__publicField(Marker, "contextType", MapContext);
var ClusterIcon = (
  /** @class */
  function() {
...
var ClustererComponent = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setClustererCallback", () => {
...
__publicField(ClustererComponent, "contextType", MapContext);
...
function InfoBoxFunctional({ children, anchor, options, position, zIndex, onCloseClick, onDomReady, onContentChanged, onPositionChanged, onZindexChanged, onLoad, onUnmount }) {
  ...
  (0, import_react.useEffect)(() => {
    if (map) {
      const { position: position2, ...infoBoxOptions } = options || defaultOptions$3;
      let positionLatLng;
...
var InfoBoxComponent = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "open", (infoBox, anchor) => {
      if (anchor) {
    ...
    __publicField(this, "setInfoBoxCallback", () => {
...
__publicField(InfoBoxComponent, "contextType", MapContext);
var fastDeepEqual;
...
var SuperClusterViewportAlgorithm = class extends AbstractViewportAlgorithm {
  ...
  calculate(input) {
    ...
    let changed = !equal2(this.state, state);
    if (!equal2(input.markers, this.markers)) {
      changed = true;
      this.markers = [...input.markers];
      const points = this.markers.map((marker) => {
...
var InfoWindow = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "open", (infoWindow, anchor) => {
      if (anchor) {
    ...
    __publicField(this, "setInfoWindowCallback", () => {
...
__publicField(InfoWindow, "contextType", MapContext);
var eventMap$b = {
  onClick: "click",
  onDblClick: "dblclick",
  onDrag: "drag",
...
var Polyline = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setPolylineCallback", () => {
...
__publicField(Polyline, "contextType", MapContext);
var eventMap$a = {
  onClick: "click",
  onDblClick: "dblclick",
  onDrag: "drag",
...
function PolygonFunctional({ options, draggable, editable, visible, path, paths, onDblClick, onDragEnd, onDragStart, onMouseDown, onMouseMove, onMouseOut, onMouseOver, onMouseUp, onRightClick, onClick, onDrag, onLoad, onUnmount, onEdit }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    google.maps.event.addListener(instance.getPath(), "insert_at", () => {
      onEdit == null ? void 0 : onEdit(instance);
    });
...
__publicField(Polygon, "contextType", MapContext);
var eventMap$9 = {
  onBoundsChanged: "bounds_changed",
  onClick: "click",
  onDblClick: "dblclick",
...
var Rectangle = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setRectangleCallback", () => {
...
__publicField(Rectangle, "contextType", MapContext);
var eventMap$8 = {
  onCenterChanged: "center_changed",
...
var Circle = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setCircleCallback", () => {
  ...
  componentWillUnmount() {
    ...
    if (this.state.circle !== null) {
      ...
      unregisterEvents(this.registeredEvents);
      (_a = this.state.circle) == null ? void 0 : _a.setMap(null);
    }
  }
  render() {
    return null;
...
__publicField(Circle, "contextType", MapContext);
var eventMap$7 = {
  onClick: "click",
  onDblClick: "dblclick",
  onMouseDown: "mousedown",
...
var Data = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setDataCallback", () => {
...
__publicField(Data, "contextType", MapContext);
var eventMap$6 = {
  onClick: "click",
...
var KmlLayer = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setKmlLayerCallback", () => {
...
__publicField(KmlLayer, "contextType", MapContext);
...
function createOverlay(container, pane, position, bounds, getPixelPositionOffset) {
  class Overlay extends google.maps.OverlayView {
    ...
    onAdd() {
      var _a;
      const pane2 = (_a = this.getPanes()) == null ? void 0 : _a[this.pane];
      pane2 == null ? void 0 : pane2.appendChild(this.container);
    }
    draw() {
      const projection = this.getProjection();
      const offset = {
        ...this.container ? getOffsetOverride(this.container, getPixelPositionOffset) : {
          x: 0,
          y: 0
        }
      };
...
function OverlayViewFunctional({ position, bounds, mapPaneName, zIndex, onLoad, onUnmount, getPixelPositionOffset, children }) {
  ...
  (0, import_react.useEffect)(() => {
    onLoad == null ? void 0 : onLoad(overlay);
    overlay == null ? void 0 : overlay.setMap(map);
    return () => {
      onUnmount == null ? void 0 : onUnmount(overlay);
...
var OverlayView = class extends import_react.PureComponent {
  constructor(props) {
    ...
    __publicField(this, "overlayView");
    __publicField(this, "containerRef");
    __publicField(this, "updatePane", () => {
    ...
    __publicField(this, "onAdd", () => {
      var _a, _b;
      this.updatePane();
      (_b = (_a = this.props).onLoad) == null ? void 0 : _b.call(_a, this.overlayView);
    });
    __publicField(this, "onPositionElement", () => {
    ...
    __publicField(this, "onRemove", () => {
      ...
      (_b = (_a = this.props).onUnmount) == null ? void 0 : _b.call(_a, this.overlayView);
    });
...
__publicField(OverlayView, "FLOAT_PANE", `floatPane`);
__publicField(OverlayView, "MAP_PANE", `mapPane`);
__publicField(OverlayView, "MARKER_LAYER", `markerLayer`);
__publicField(OverlayView, "OVERLAY_LAYER", `overlayLayer`);
__publicField(OverlayView, "OVERLAY_MOUSE_TARGET", `overlayMouseTarget`);
__publicField(OverlayView, "contextType", MapContext);
function noop() {
  return;
}
var eventMap$5 = {
...
var GroundOverlay = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setGroundOverlayCallback", () => {
...
__publicField(GroundOverlay, "defaultProps", {
  onLoad: noop
});
__publicField(GroundOverlay, "contextType", MapContext);
var eventMap$4 = {};
var updaterMap$4 = {
  data(instance, data) {
...
var HeatmapLayer = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setHeatmapLayerCallback", () => {
...
__publicField(HeatmapLayer, "contextType", MapContext);
var eventMap$3 = {
  onCloseClick: "closeclick",
...
var StreetViewPanorama = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setStreetViewPanoramaCallback", () => {
  ...
  componentDidMount() {
    var _a;
    const streetViewPanorama = ((_a = this.context) == null ? void 0 : _a.getStreetView()) ?? null;
    this.registeredEvents = applyUpdatersToPropsAndRegisterEvents({
...
__publicField(StreetViewPanorama, "contextType", MapContext);
var StreetViewService = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setStreetViewServiceCallback", () => {
...
__publicField(StreetViewService, "contextType", MapContext);
var DirectionsService = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setDirectionsServiceCallback", () => {
...
var DirectionsRenderer = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setDirectionsRendererCallback", () => {
...
__publicField(DirectionsRenderer, "contextType", MapContext);
var DistanceMatrixService = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setDistanceMatrixServiceCallback", () => {
...
var StandaloneSearchBox = class extends import_react.PureComponent {
  constructor() {
    super(...arguments);
    __publicField(this, "registeredEvents", []);
    __publicField(this, "containerElement", (0, import_react.createRef)());
    __publicField(this, "state", {
      searchBox: null
    });
    __publicField(this, "setSearchBoxCallback", () => {
...
__publicField(StandaloneSearchBox, "contextType", MapContext);
var eventMap = {
...
var Autocomplete = class extends import_react.PureComponent {
  constructor() {
    ...
    __publicField(this, "setAutocompleteCallback", () => {
  ...
  componentDidMount() {
    var _a;
    invariant(!!google.maps.places, 'You need to provide libraries={["places"]} prop to <LoadScript /> component %s', google.maps.places);
    const input = (_a = this.containerElement.current) == null ? void 0 : _a.querySelector("input");
    if (input) {
...
__publicField(Autocomplete, "contextType", MapContext);
export {
  Autocomplete,
  BicyclingLayer,
  BicyclingLayerF,
